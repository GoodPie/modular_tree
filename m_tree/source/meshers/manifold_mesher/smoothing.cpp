...
void smooth_mesh_once(std::vector<Vector3>* result, const std::vector<Vector3>* previous_iteration,
                      const std::vector<std::vector<int>>& neighbourhoods, float factor,
